...
public class LoaderApplication {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            Object myClass1AndreyObject1 = obj1.getClass().getConstructor(String.class).newInstance("Andrey");
            ...
            Object myClass1KirillObject1 = obj1.getClass().getConstructor(String.class).newInstance("Kirill");
